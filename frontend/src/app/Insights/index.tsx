...
import type { Question } from "@/features/questions/questionSlice"; // Add this import
import {
  Bar,
  BarChart,
  CartesianGrid,
...
const Insights: React.FC = () => {
  ...
  const getRecentActivityData = () => {
    ...
    const activity = questions.reduce(
    ...
    <div className="p-6 h-screen flex flex-col">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 flex-grow">
        ...
        <div className="p-4 border rounded-lg col-span-1 md:col-span-2 flex flex-col">
          ...
          <ChartContainer
            config={{ count: { label: "Questions", color: chartColors[1] } }}
