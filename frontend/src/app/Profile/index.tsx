      ...
      <Card className="w-full max-w-3xl shadow-lg rounded-2xl p-4">
        ...
        <CardContent>
          ...
          <Tabs defaultValue="profile" className="w-full">
            ...
            <TabsContent value="profile" className="p-4 space-y-4 min-h-[280px]">
            ...
            <TabsContent value="settings" className="p-4 space-y-4 min-h-[280px]">
            ...
            <TabsContent value="security" className="p-4 space-y-4 min-h-[280px]">
